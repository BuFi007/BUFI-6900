...
// `src/plugins/session/permissions/ISessionKeyPermissionsUpdates.sol`, commit 1ceb7935. Only the interface import
// is renamed (`ISessionKeyPlugin` -> `IBufiSessionKeyPlugin`); every selector is unchanged. See ../PORT-NOTES.md.
...
interface ISessionKeyPermissionsUpdates {
    ...
    function setAccessListType(IBufiSessionKeyPlugin.ContractAccessControlType contractAccessControlType) external;
