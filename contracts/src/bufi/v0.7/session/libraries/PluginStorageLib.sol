...
//
// BUFI provenance: vendored VERBATIM (pragma pinned to 0.8.24) from alchemyplatform/modular-account v1.0.1
// `src/libraries/PluginStorageLib.sol`, commit 1ceb7935. erc6900/modular-account-libs ships the same code as
// `ModuleStorageLib`; it is vendored under its original name so the session-key storage derivation can be diffed
// against the audited upstream line-for-line. See ../PORT-NOTES.md.
