...
// Generated from contracts/out/BufiSessionKeyPlugin.sol/BufiSessionKeyPlugin.json (forge artifact of contracts/src/bufi/v0.7/session/BufiSessionKeyPlugin.sol). Regenerate after a contract change; do not hand-edit.

export const BufiSessionKeyPluginABI = [
  {
    type: "function",
    name: "addSessionKey",
    inputs: [
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct IBufiSessionKeyPlugin.SpendLimitInfo",
        components: [
          {
            name: "hasLimit",
            type: "bool",
