...
export interface IsSessionKeyOfParameters {
  /**
...
/**
 * Checks whether a key is a registered session key of the account.
 * @param client - Client to use.
 * @param params - Parameters to use. See {@link IsSessionKeyOfParameters}.
 * @returns True if the key is a session key of the account.
 */
export async function isSessionKeyOf(
  client: Client<Transport, Chain | undefined>,
  params: IsSessionKeyOfParameters,
): Promise<boolean> {
